...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auth', '0012_alter_user_first_name_max_length'),  # ensure auth app migrations dependency
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(to='auth.Permission', blank=True, related_name='user_set', related_query_name='user', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
